...
p = argparse.ArgumentParser(description='Output the Binny YAML text to the standard output stream.')
p.add_argument('-f', help='FA file path.')
p.add_argument('-b', help='BAM file path.')
